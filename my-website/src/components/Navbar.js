...
const Navbar = () => {
  ...
  return (
    <nav className="navbar fixed top-6 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-700 to-indigo-800 text-white py-5 px-6 rounded-full shadow-2xl z-40 max-w-[75%] transition-all duration-300 ease-in-out group bg-opacity-60 ms-32" style={{ opacity }}>
      <div className="flex items-center justify-between w-full">
        ...
        {isMenuOpen && (
          <div className="absolute top-full right-0 w-48 bg-gradient-to-r from-purple-700 to-indigo-800 mt-4 rounded-2xl p-4 shadow-lg md:hidden">
